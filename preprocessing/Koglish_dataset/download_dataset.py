...
class LoadSST2:
    ...
    def get_english_dataset():
        ...
        dataset = load_dataset('Jangyeong/Koglish_GLUE', data_files={
        ...
        print(f"English Train data of Koglih_GLUE on ****SST2**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****SST2**** saved to {valid_save_path}")
        print(f"English Test data Koglih_GLUE on ****SST2**** saved to {test_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****SST2**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****SST2**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****SST2**** saved to {test_save_path}")
...
class LoadMRPC:
    ...
    def get_english_dataset():
        ...
        print(f"English Train data of Koglih_GLUE on ****MRPC**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****MRPC**** saved to {valid_save_path}")
        print(f"English Test data Koglih_GLUE on ****MRPC**** saved to {test_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****MRPC**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****MRPC**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****MRPC**** saved to {test_save_path}")
...
class LoadCOLA:
    ...
    def get_english_dataset():
        ...
        print(f"English Train data of Koglih_GLUE on ****COLA**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****COLA**** saved to {valid_save_path}")
        print(f"English Test data Koglih_GLUE on ****COLA**** saved to {test_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****COLA**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****COLA**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****COLA**** saved to {test_save_path}")
...
class LoadRTE:
    ...
    def get_english_dataset():
        ...
        print(f"English Train data of Koglih_GLUE on ****RTE**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****RTE**** saved to {valid_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****RTE**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****RTE**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****RTE**** saved to {test_save_path}")
...
class LoadSTSB:
    ...
    def get_english_dataset():
        ...
        print(f"English Train data of Koglih_GLUE on ****STS_B**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****STS_B**** saved to {valid_save_path}")
        print(f"English Test data Koglih_GLUE on ****STS_B**** saved to {test_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****STS_B**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****STS_B**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****STS_B**** saved to {test_save_path}")
...
class LoadQNLI:
    ...
    def get_english_dataset():
        ...
        print(f"English Train data of Koglih_GLUE on ****QNLI**** saved to {train_save_path}")
        print(f"English Validation data of Koglih_GLUE on ****QNLI**** saved to {valid_save_path}")
        print(f"English Test data Koglih_GLUE on ****QNLI**** saved to {test_save_path}")
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Train data of Koglih_GLUE on ****QNLI**** saved to {train_save_path}")
        print(f"Code-Switched Validation data of Koglih_GLUE on ****QNLI**** saved to {valid_save_path}")
        print(f"Code-Switched Test data Koglih_GLUE on ****QNLI**** saved to {test_save_path}")
...
class LoadNLI:
    ...
    def get_english_dataset():
        ...
        dataset = load_dataset('Jangyeong/Koglish_NLI', data_files={
                                    'en_train': 'en_train.csv'
                                    })
...
class LoadSTSB_for_ConCSE:
    ...
    def get_english_dataset():
        ...
        dataset = load_dataset('Jangyeong/Koglish_STS', data_files={
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_B saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_B saved to {cs_test_save_path}")
...
class LoadSTS12:
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_12 saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_12 saved to {cs_test_save_path}")
...
class LoadSTS13:
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_13 saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_13 saved to {cs_test_save_path}")
...
class LoadSTS14:
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_14 saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_14 saved to {cs_test_save_path}")
...
class LoadSTS15:
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_15 saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_15 saved to {cs_test_save_path}")
...
class LoadSTS16:
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_16 saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/STS_16 saved to {cs_test_save_path}")
...
class LoadSICK:
    ...
    def get_english_dataset():
        ...
        dataset = load_dataset('Jangyeong/Koglish_SICK', data_files={
                                    'en_valid': 'en_valid.csv',
                                    'en_test': 'en_test.csv'
                                    })
        en_valid_data = dataset['en_valid']
        en_test_data = dataset['en_test']
    ...
    def get_code_swhiched_dataset():
        ...
        print(f"Code-Switched Valid,Test data of Koglish_STS/SICK saved to {cs_valid_save_path}")
        print(f"Code-Switched Valid,Test data of Koglish_STS/SICK saved to {cs_test_save_path}")
